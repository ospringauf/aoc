...
class Day21p2 extends AocPuzzle {
...
//        r += t8.val(s);
//        // N
//        r += t7.val(s) + 2 * t6.val(s);
//        // S
//        r += t9.val(s) + 1 * ta.val(s);
//        // W
//        r += t5.val(s) + t4.val(s) + 1 * t2.val(s);
//        // E
//        r += tc.val(s) + te.val(s) + 0 * tf.val(s);
//
//        // NE
//        r += 3 * tb.val(s);
//        // NW
