...
public class Day03 {
	...
	/**
	 * Pos represents a single (x,y) location
	 */
	static class Pos {
		private int x;
		private int y;
		public static Pos START = new Pos(0, 0);
...
//	String input2 = "U62,R66,U55,R34,D71,R55,D58,R83";
	...
	/**
	 * produce all locations of a wire along its path 
	 */
	private List<Pos> path(String input) {
		var segments = input.split(",");
		var locations = new ArrayList<Pos>();
		var p = Pos.START;
	...
	/**
	 * all intersection locations of two paths
	 */
	private Set<Pos> intersect(List<Pos> l1, List<Pos> l2) {
		var intersections = new HashSet<Pos>(l1);
		intersections.retainAll(new HashSet<Pos>(l2));
